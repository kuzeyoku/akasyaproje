    ...
    <div class="container">
        <div class="main-content">
            <div class="row align-items-center">
                <div class="col-lg-5">
                    <img src="https://images.unsplash.com/photo-1724679975383-0719715f8723?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NTY2NzF8MHwxfHNlYXJjaHwyfHxtYXBwaW5nJTIwcHJvZmVzc2lvbmFsc3xlbnwwfHx8fDE3NjAxMzM5OTB8MA&ixlib=rb-4.1.0&q=85"
                        alt="{{ setting('general', 'title') }}" class="hero-image">
                </div>
                <div class="col-lg-7">
