    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 mx-auto text-center mb-5">
                <h2 class="display-5 fw-bold mb-3" data-aos="fade-up">Blog</h2>
                <p class="lead text-muted" data-aos="fade-up" data-aos-delay="200">
                    Harita mühendisliği alanındaki son gelişmeler ve uzman görüşlerimiz
                </p>
            </div>
        </div>
            ...
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                <article class="blog-card h-100">
                    <div class="blog-image">
                        <img src="{{ $blog->image }}"
                            alt="Drone Teknolojisi" class="img-fluid">
                    </div>
        ...
        <div class="text-center mt-5" data-aos="fade-up">
            <a href="{{ route("blogs.index") }}" class="btn btn-primary btn-lg">Tüm Blog Yazılarını Okuyun</a>
        </div>
    </div>
</section>
